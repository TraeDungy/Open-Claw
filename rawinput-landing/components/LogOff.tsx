...
const CONTENT = [
  ...
  },
  {
    ...
    agent: "Maya",
    tags: ["Events", "Festivals", "Scene", "Monthly"],
  },
  {
    tab: "scene",
  ...
  },
  {
    ...
    desc: "The grind is real. The burnout is realer. How to set boundaries, take PTO without checking Slack, and rebuild when you've already crashed.",
    agent: "OG-PT",
  ...
  },
  {
    ...
    agent: "Maya",
    tags: ["Cooking Class", "Virtual", "Skills", "Community"],
  },
  {
    tab: "experiences",
    category: "CONNECTION",
